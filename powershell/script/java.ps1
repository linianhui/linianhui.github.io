function Java-Arthas() {
    ...
    Log-Debug "java -jar ${ENV:ARTHAS_BOOT_HOME}arthas-boot.jar --repo-mirror aliyun --use-http $ARGS"
    java -jar ${ENV:ARTHAS_BOOT_HOME}arthas-boot.jar --repo-mirror aliyun --use-http $ARGS
}
